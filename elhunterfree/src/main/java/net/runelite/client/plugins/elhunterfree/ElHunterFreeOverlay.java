...
@Slf4j
@Singleton
class ElHunterFreeOverlay extends OverlayPanel
{
    private final ElHunterFreePlugin plugin;
    private final ElHunterFreeConfig config;

    String timeFormat;

    @Inject
    private ElHunterFreeOverlay(final Client client, final ElHunterFreePlugin plugin, final ElHunterFreeConfig config)
    {
        super(plugin);
