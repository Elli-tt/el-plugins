...
@Slf4j
@Singleton
class ElBarbarianOverlay extends OverlayPanel
{
	private final ElBarbarianPlugin plugin;
	private final ElBarbarianConfiguration config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private ElBarbarianOverlay(final Client client, final ElBarbarianPlugin plugin, final ElBarbarianConfiguration config)
	{
		super(plugin);
