...
@Slf4j
@Singleton
class ElZMIOverlay extends OverlayPanel
{
    private final ElZMIPlugin plugin;
    private final ElZMIConfig config;

    String timeFormat;

    @Inject
    private ElZMIOverlay(final Client client, final ElZMIPlugin plugin, final ElZMIConfig config)
    {
        super(plugin);
